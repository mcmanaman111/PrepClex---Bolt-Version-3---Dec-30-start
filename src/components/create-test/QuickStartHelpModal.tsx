  ...
  const features = [
    {
      ...
      description: 'Begin a practice test immediately with randomly selected unused questions from your question bank.'
    },
    {
      icon: Settings,
      title: 'Customizable Settings',
      description: 'Click the gear icon to customize your test settings:',
      subFeatures: [
